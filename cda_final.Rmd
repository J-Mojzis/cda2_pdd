...
(graf_pos_total <- (ggplot(df_pos_total) +
  ...
  scale_fill_brewer(type = "div", palette = "Pastel1", direction = -1) +
...
quantil_25 <- quantile(df$bet, 0.25, na.rm = TRUE)
...
herkunft <- ggplotl<(ggplot(cum_as_nat, aes(x = Year, y = Amount, fill = Country)) +
...
api_create(herkunft, filename = "Asylgesuche")
```
